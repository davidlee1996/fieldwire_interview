...
def log_test_start_messages(logger):
    logger.info("*******************************************************")
    logger.info("**************** TEST SCENARIO START ******************")
    logger.info("*******************************************************")


def log_test_method_name(logger, method_name):
    logger.info("*******************************************************")
    logger.info("    Test Method: " + method_name)
    logger.info("*******************************************************")
...
class WebDriverListener(AbstractEventListener):
    ...
    def after_quit(self, driver):
        ...
        self.logger.info("*******************************************************")
        self.logger.info("**************** TEST SCENARIO END ****************")
        self.logger.info("*******************************************************")
